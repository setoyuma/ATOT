...
class Button():
    ...
    def __init__(self, x, y, width, height, buttonText="button", onClickFunction=None, onePress=False, path=''):
        ...
        self.buttonSurface = pg.image.load('../graphics/ui/buttons/button_plate1.png').convert_alpha()
