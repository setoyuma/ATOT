...
class Game:
    ...
    def Pause(self):
        ...
        res = Button(100,0,200,100,"Resume",self.Play,True,'../graphics/ui/buttons/button_plate1.png')
        opt = Button(SCREEN_WIDTH - 100,0,200,100,"Options",self.Options,True,'../graphics/ui/buttons/button_plate1.png')
        ex = Button(100,SCREEN_HEIGHT - 100,200,100,"Exit",sys.exit,True,'../graphics/ui/buttons/button_plate1.png')
